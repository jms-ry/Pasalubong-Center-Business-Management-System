...
export default class extends Controller {
  static targets =['companyName','companyAbbreviation','emailAddress','streetOne','streetTwo','municipality','city','zipCode','supplierId','supplierName','supplierAbbreviation','supplierEmail','supplierStreetOne','supplierStreetTwo','supplierMunicipality','supplierCity','supplierZipCode','searchField','sortField'];
  connect() {
  }
