<div class="modal fade" id="createAccountModal" tabindex="-1" aria-labelledby="createAccountModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" data-controller="form-validation">
      ...
      <form action="{{route('accounts.store')}}" method="POST" id="createAccountForm">
        ...
        <div class="modal-body">
          ...
          <div class="row g-2">
            <div class="col-7">
              <div class="mb-3 fw-bold">
                ...
                <input type="text" class="form-control" id="name" name="name" required placeholder="Enter Full Name"data-action="input->form-validation#validateNameField">
          ...
          <div class="mb-3 fw-bold">
            ...
            <input type="email" class="form-control" id="email" name="email" required placeholder="Enter Email" data-action="input->form-validation#validateEmailAddressField">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" id="createOrUpdateButton" data-action="click->user#enableFields">Create Account</button>
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-action="click->user#enableFields click->form-validation#clearFields">Cancel</button>
        </div>
      </form>
    </div>
  </div>
