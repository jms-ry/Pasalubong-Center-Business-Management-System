...
export default class extends Controller {
  static targets = 
    ['firstName','lastName', 'email', 'streetOne', 'streetTwo', 'municipality', 'city', 'zipCode','customerId',   'customerFirstName', 'customerLastName', 'customerEmail', 'customerStreetOne', 'customerStreetTwo', 'customerMunicipality', 'customerCity', 'customerZipCode','searchField','sortField'];
