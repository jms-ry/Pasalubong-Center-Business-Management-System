    ...
    <div class="card-body bg-dark" data-controller="employee">
      ...
      <div class="container d-flex justify-content-end align-items-end fw-bold">
        <div class="row g-1">
          ...
          <div class="col-auto">
            <button class="btn btn-outline-success fw-bold text-light {{ request()->is('employees') && empty(request()->query()) ? 'd-none' : '' }}" type="button" onclick="window.location.href='/employees'">
              Back to Employees
            </button>
          </div>
        </div>
